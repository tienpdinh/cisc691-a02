...
class TestAuthorshipIdentifier(unittest.TestCase):
    ...
    def test_make_signature(self):
        text = "A pearl! Pearl! Lustrous pearl! Rare, what a nice find."
        expected_signature = [4.1, 0.7, 0.5, 2.5, 1.25]
    ...
    def test_get_score(self):
        signature1 = [4.6, 0.1, 0.05, 10, 2]
        signature2 = [4.3, 0.1, 0.04, 16, 4]
        weights = [11, 33, 50, 0.4, 4]
        self.assertAlmostEqual(
            get_score(signature1, signature2, weights), 14.2, places=1
        )

    def test_lowest_score(self):
        signatures_dict = {"Dan": [1, 1, 1, 1, 1], "Leo": [3, 3, 3, 3, 3]}
        unknown_signature = [1, 0.8, 0.9, 1.3, 1.4]
        weights = [11, 33, 50, 0.4, 4]
        self.assertEqual(
